...
throws IOException, ServletException, SQLException {
		...
		String name =(String)session1.getAttribute("welcome");
		String email =(String)session1.getAttribute("email");

		String eid ="timecalibrator2015@gmail.com";
		...
		String to =eid;
		String subject = "Time calibrator FeedBack";
    
		String msg1="You have a FeedBack from "+name+" \nEmail:"+email+"\nFeedBack:"+feedback;
