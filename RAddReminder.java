 ...
 */
@WebServlet("/RAddReminder")
public class RAddReminder extends HttpServlet {
	       ...
	       String s1,s2,s3,s4,s5,s6,s_time;
	        ...
	        String dt=dateFormat.format(new Date());
	       	...
	       	{	
      			...
      			//response.sendRedirect("JspPages/raddreminder.jsp?tid="+tid);
      			out.println ("<script type=\"text/javascript\">");
    			out.println("alert('Time Already Passed!');");
    			out.println("location='JspPages/raddreminder.jsp?tid="+tid+"'; ");
    			out.println("</script>");
	       	}
	       	else
	       	{
			   ...
			   if(rs>0)
			   {
				//   JOptionPane.showMessageDialog(null,"Reminder Added!!");		    
				   response.sendRedirect("AddNewReminder");
			   }
			   else
			   {
