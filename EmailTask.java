...
/**
 * Servlet implementation class EmailTask
 */
@WebServlet("/EmailTask")
...
throws IOException, ServletException, SQLException {
		...
		final String succ = "Notification";
		HttpSession session1 = request.getSession(false);
		ResultSet rs = (ResultSet)session1.getAttribute("rs2");
		...
		rs.beforeFirst();
		String msg1="	Tname  Ttime Description Priority \n";
		//String msg1;
		for(int i=1;i<count;i++)
		{	
			rs.next();
			msg1=msg1+rs.getString("Tname")+" "+rs.getString("Ttime")+" "+rs.getString("Tdescription")+" "+rs.getString("Tpriority")+"\n\n";
