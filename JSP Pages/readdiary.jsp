	        ...
	        for(int j=1;j<=7;j++)
	        {
               ...
               <% 
		        ...
		        else
		        {
		         ...
		         %>
		         <td align="center" height="35" id="day_<%=(cnt-weekStartDay+1)%>"><span><a href="../ReadDiary?dt=<%=x%>&yr=<%=iYear%>&m=<%=iMonth+1%>"><%=(cnt-weekStartDay+1)%></a></span></td>
...
<a href="diarycalender.jsp"><img src="images/back2.png" width="100" height="40" style="top:100px;"></a>
