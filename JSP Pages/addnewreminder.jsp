...
%>
<body bgcolor="yellow">
<center><font size = "6"color = "red"><b>Add Reminder</b></font></center>
<br>
<center>
<table border="10" align="center"  cellpadding="20" cellspacing="4" bordercolor = "red">
	...
	<td><font size = 5.5 color = "brrowen">&nbsp;Reminder&nbsp;</font></td>
</tr>
  <% 
  try
  {	
...
//	Db.getConnection("jdbc:mysql://localhost/goal");
...
<td><a href="raddreminder.jsp?tid=<%=rs.getInt("Tid") %>"><img src="images/reminder.png" width="80" height="40" /></a></td>
	</tr>
