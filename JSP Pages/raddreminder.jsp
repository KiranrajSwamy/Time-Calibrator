...
%>
  ...
  <% 
	...
	ResultSet rs=Db.select("select * from Task where Tid="+tid);
  	rs.next();
	%>					
...
<form action=../RAddReminder method=get >

<head>
<center>

<fieldset style="border-width: 10px;">
	<legend><font size = "6" color = "#462276"><b>Add Reminder</b></font></legend>
	<br><br>
...
<style>
	.separator{height:20px}
		...
		<tr>
			<td><font size="4" color="black"><i><b>Task Name:</b></i></font></td>
			<td><input type=text name=tname value="<%=rs.getString("Tname") %>" style="height:20px;font-size:14pt;" readonly="readonly"></td>
		</tr>
		<tr><td class= "separator"></td></tr>


		<tr>
			<td><font size="4" color="black"><i><b>Date:</b></i></font></td>
			<td><input type=text name=date value="<%=rs.getString("Tdate") %>" style="height:20px;font-size:14pt;" readonly="readonly"></td>
		</tr>
		<tr><td class= "separator"></td></tr>
	
		<tr>
			<td><font size="4" color="black"><i><b>Time:</b></i></font></td>
			<td><input type=text name=time value="<%=rs.getString("Ttime") %>" style="height:20px;font-size:14pt;" readonly="readonly"></td>
		</tr>
		<tr><td class= "separator"></td></tr>
		
		<tr>
			<td><font size="4" color="black"><i><b>Description:</b></i></font></td>
			<td><textarea name=description  readonly="readonly"><%=rs.getString("Tdescription") %></textarea></td>
		</tr>
		<tr><td class= "separator"></td></tr>
		
		<tr>
			<td><font size="4" color="black"><i><b>Priority:</b></i></font></td>
			<td><select name="priority" readonly="readonly">
			<option value="imp/urgent">imp/urgent</option>
			<option value="imp/not urgent">imp/not urgent</option>
			<option value="not imp/urgent">not imp/urgent</option>
			<option value="not imp/not urgent">not imp/not urgent</option>
				</select >
			</td>
		</tr>
		<tr><td class= "separator"></td></tr>
		...
		<tr>
		<td><font size="4" color="black"><i><b>Enter the Reminder date:<font color=red>*</font></b></i></font></td>
		<td><input type=date name=reminderdate id="inputField" style="height:20px;font-size:14pt;" required=""><i>(yyyy/mm/dd)</i> </td>
		</tr>
	<tr><td class= "separator"></td></tr>

	<tr>
	<td><font size="4" color="black"><i><b>Enter the Reminder time:<font color=red>*</font></b></i></font></td>
	<td><input type=text name="rtime" pattern="[0-2]{1}[0-9]{1}:[0-5]{1}[0-9]{1}" required="" >eg:23:50(hh:mm) </td>
<tr><td class= "separator"></td></tr>

</td>
			<tr>
			<td><td><input type="image" src="images/add.png" alt="Submit" width="150" height="40">
			</td></td>
							</tr>
</table>
</fieldset>
</center>
<a href="../AddNewReminder"><img src="images/back2.png" width="100" height="40" style="top:100px;"></a>
</body>
</div>
