...
<form action="../ViewTaskRange" method=get>
<head>
...
<head></head>
	...
	<tr><td><font size="4" color="Black"><i>Enter From Date</i></font></td>
	<td><input type=date name="mindate" id="inputField" required=""> </td></tr>
	<tr><td class= "separator"></td></tr>


	<tr><td><font size="4" color="Black"><i>Enter To Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</i></font></td>
	<td><input type=date name="maxdate" id="inputField1" required=""> </td></tr>
	<tr><td class= "separator"></td></tr>

</tr>
<tr>
	<td><td><input type=submit name=submit value="view">
	<input type=reset name=reset></td></td>
</tr>
</table>
</fieldset>
</center>
