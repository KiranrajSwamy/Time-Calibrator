...
%>			<form action="home.jsp" method=get>
			...
			<table>
			<tr>
			<td><font size =4 color = "grey">Task Name: </font></td><td><font size =4 color = "black"><%=rs.getString("Tname")%></font></td></tr>
			<tr><td class= "separator"></td></tr>
			<tr><td><font size =4 color = "grey">Task Date:</font></td><td><font size =4 color = "black"><%=rs.getString("Tdate")%></font></td></tr>
			<tr><td class= "separator"></td></tr>
			<tr><td><font size =4 color = "grey">Task Time:</font></td><td><font size =4 color = "black"><%=rs.getString("Ttime")%></font></td></tr>
			<tr><td class= "separator"></td></tr>
			<tr><td><font size =4 color = "grey">Task Description:</font></td><td><font size =4 color = "black"><%=rs.getString("Tdescription")%></font></td></tr>
			<tr><td class= "separator"></td></tr>
			<tr><td><font size =4 color = "grey">Task Priority:</font></td><td><font size =4 color = "black"><%=rs.getString("Tpriority")%></font></td></tr>
			<tr><td class= "separator"></td></tr>
			<tr><td><td/><input type="submit"  value="Ok">
			<a href="updatestatusdate.jsp?tid=<%=rs.getString("Tid")%>"   style="text-decoration:none;"><input type=button value="update Status"></a></td>
			</tr>
