...
%>
<%
    	ResultSet rs1=Db.select("select * from User where Uid="+uid);
  		rs1.next();
	%>  
	<center>
<head>
...
function validate()
	...
	//String numToken="[\\p{Digit}&&[123456789]]+";
		...
		function check_name(name) //login-name check 
		{   
		...
		function check_username(uadd)  //username-check
		{   
			var letters = /^[a-zA-Z\-]{3,30}$/; 
...
<body  text="#FF0000">
		<form method="get" action="../EditInfo" name="myform" onsubmit = "return validate();" >

			<table>
				<tr>
					<td><b><font size=4>Enter the User Name:</font></b></td>
					<td><input type=text name=uname value="<%=rs1.getString(2) %>" style="height:20px;font-size:14pt;">
					</td>
					<tr><td class= "separator"></td></tr>
				</tr>
				<tr>
					<td><b><font size=4>Enter the Contact:</font></b></td>
					<td><input type=text name=contact
						value="<%=rs1.getString("Contact") %>" maxlength="10" style="height:20px;font-size:14pt;">
					</td>
					<tr><td class= "separator"></td></tr>
				</tr>
				
				<tr>
					<td><b><font size=4>Enter the Email-id:</font></b></td>
					<td><input type=text name=email
						value="<%=rs1.getString("Email") %>" style="height:20px;font-size:14pt;">
					</td>
					<tr><td class= "separator"></td></tr>
				</tr>
				...
				<tr>
					...
					<td><input type=text name=lname
						value="<%=rs1.getString("Lname") %>" style="height:20px;font-size:14pt;" readonly >
					</td>
					<tr><td class= "separator"></td></tr>
				</tr>

				<tr>
				<td><b><font size=4>Security Question</font></b></td>
				<td><select name="secQues" >
				<option value="<%=rs1.getString("Sec_q") %>" readonly><%=rs1.getString("Sec_q") %></option>
				</select>
				</td>
					<tr><td class= "separator"></td></tr>
				</tr>
				<tr>
					<td><b><font size=4>Security Answer</font></b></td>
					<td><input type=text name=ans value="<%=rs1.getString("Sec_a")%>" style="height:20px;font-size:14pt;" readonly></td>
					<tr><td class= "separator"></td></tr>
