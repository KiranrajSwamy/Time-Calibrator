...
<fieldset style="border-width: 10px;">
	<legend><font size = "6" color = "#462276"><b>Add Your New Task</b></font></legend>
	<br><br>
...
<style>
	.separator{height:20px}
		...
		<tr>
	<td><font size="4" color="black"><i><b>Enter the Task Name <font color="red">*</font></b></i></font></td>
	<td><input type=text name=tname id = "tname"  style="height:20px;font-size:14pt;" required=""></td>
	<tr><td class= "separator"></td></tr>
		
</tr>
<tr>
	<td><font size="4" color="black"><i><b>Enter the date<font color=red>*</font></b></i></font></td>
	<td><input type=date name="tdate"  id="inputField"  style="height:20px;font-size:14pt;" required=""><i><font size="3">(yyyy/mm/dd)</font></i> </td>
	<tr><td class= "separator"></td></tr>
		
</tr>
<tr>
	<td><font size="4" color="black"><i><b>Enter the time<font color="red">*</font></b></i></font></td>
	<td><input type=text name="ttime" pattern="[0-2]{1}[0-9]{1}:[0-5]{1}[0-9]{1}" required=""  ><font size="3">eg:23:50(hh:mm)</font> </td>
<tr><td class= "separator"></td></tr>
<tr>
	<td><font size="4" color="black"><i><b>Enter the Task Description<font color="red">*</font></b></i></font></td>
<td>
...
<tr><td class= "separator"></td></tr>
<tr>
	<td><font size="4" color="black"><i><b>Enter the Priority<font color="red">*</font> </b></i></font></td>
