...
<form action=../AddReminder method=get>
<head><title>Add Reminder</title>
<center>
...
<script type="text/javascript">
	window.onload = function(){
		...
		<tr>
			<td><font size=3 color=black>Task Name:</font></td>
			<td><input type=text name=tname value="<%=rs.getString("Tname") %>" readonly="readonly"></td>
		</tr>
		<tr>
			<td><font size=3 color=black>Date:</font></td>
			<td><input type=text name=date value="<%=rs.getString("Tdate") %>" readonly="readonly"></td></tr>
		<tr>
			<td><font size=3 color=black>Time:</font></td>
			<td><input type=text name=time value="<%=rs.getString("Ttime") %>"readonly="readonly"></td>
		</tr>
		<tr>
			<td><font size=3 color=black>Description:</font></td>
			<td><textarea name=description readonly="readonly"><%=rs.getString("Tdescription") %></textarea></td>
		</tr>
		<tr>
			<td><font size=3 color=black>Priority:</font></td>
			<td><select name="priority" readonly="readonly">
			<option value="<%=rs.getString("Tpriority") %>"><%=rs.getString("Tpriority") %></option>
			</select >
			</td>
		</tr>
	<tr>
	<td><font size=3 color=black>Enter the Reminder date:</font></td>
	<td><input type=date name=reminderdate id="inputField" required=""><i>(yyyy/mm/dd)</i> </td>
</tr>
<tr>
	<td><font size=3 color=black>Enter the Reminder time:</font></td>
...
<td>			<td><input type=submit name=submit value="Add"></td>
</td>
				</tr>
</table>
</fieldset>
...
<a href="../DisplayTask"><img src="images/back2.png" width="100" height="40" style="top:100px;"></a>
