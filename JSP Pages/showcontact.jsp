...
%>
<%	   ResultSet rs=Db.select("select * from Contactbook where Uid="+uid);
	%>  
...
<head>
<center><font size = "6"color = "red"><b>Phone Book</b></font></center>
<br>
<br>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
<table border="5" align="center" cellpadding="5" cellspacing="4" bordercolor = "orange" width="50%" bgcolor = "#f0f0f0">
	<tr bgcolor="#dee5a0">


	<td><font size = 5 color = "brrowen">&nbsp;Name&nbsp;</font></td>
	<td><font size = 5 color = "brrowen">&nbsp;Email-id&nbsp;</font></td>
	<td><font size = 5 color = "brrowen">&nbsp;Address&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
	<td><font size = 5 color = "brrowen">&nbsp;Home contact&nbsp;</font></td>
	<td><font size = 5 color = "brrowen">&nbsp;Cell no&nbsp;</font></td>
	<td><font size = 5 color = "brrowen">&nbsp;Office no&nbsp;</font></td>
	<td><font size = 5 color = "brrowen">Update</font></td>
	<td><font size = 5 color = "brrowen">Delete</font></td>
	
</tr>
<%while(rs.next()){ %>
<tr>
<td><font size =3 color = "black"><%=rs.getString("Firstname")%>&nbsp;</font>
<font size =3 color = "black"><%=rs.getString("Lastname")%></font></td>
<td><font size =3 color = "black"><%=rs.getString("Email")%></font></td>
<td><font size =3 color = "black"><%=rs.getString("Address")%></font></td>
<td><font size =3 color = "black"><%=rs.getString("Homecontactno")%></font></td>
<td><font size =3 color = "black"><%=rs.getString("Cellno")%></font></td>
<td><font size =3 color = "black"><%=rs.getString("Officeno")%></font></td>


	<td><a href="updatecontact.jsp?cid=<%=rs.getString("Cid")%>"><img src="images/editcontact.jpeg" width="70" height="40"  alt="update" title="Alter your Contact"></a></td>

	<td><a href="../DeleteContact?cid=<%=rs.getString("Cid")%>" onclick="return confirm('Are you sure you want to delete this Contact?');"><img src="images/deletecontact.png" width="70" height="40"></a></td>
...
<a href="addcontact.jsp"><img src="images/addcontact.png" width="100" height="100"></a>

<a href="searchcontact.jsp"><img src="images/searchcontact.jpeg" width="100" height="100"></a>
