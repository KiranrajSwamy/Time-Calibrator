...
<center><font size = "7"color = "orange"><b><u>List Of Tasks</u></b></font></center>
	<br>
	<br>
<form action="../SearchDisplayTask" method="get">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=text name=tname required>
<input type=submit name=submit value=search>&nbsp;&nbsp;
<a href="../DisplayTask" style="text-decoration:none;"><input type=button value=View All /></a>
...
<table border="5" align="center" cellpadding="4" cellspacing="3" bordercolor = "orange" width="50%" bgcolor = "#f0f0f0">
	...
	<td><font size = 4.9 color = "brrowen">&nbsp;Update&nbsp;</font></td>
	<td><font size = 4.9 color = "brrowen">&nbsp;Delete&nbsp;</font></td>
	<td><font size = 4.9 color = "brrowen">&nbsp;Status&nbsp;</font></td>
	<td><font size = 4.9 color = "brrowen">&nbsp;Reminder&nbsp;</font></td>
...
try
{
	...
	{   
		...
		int tid = rs2.getInt("Tid");
		 ...
		 ResultSet rs=Db.select("select Reminder.Tid,Rid from Task,Reminder where Task.Tid=Reminder.Tid  and Tstatusdate='1909-09-09'and Uid="+uid);
	...
	<td><a href="updatetask.jsp?tid=<%=rs2.getString("Tid")%>"><img src="images/edit.png" width="70" height="35"></a></td>
	
		<td><a href="../DeleteTask?tid=<%=rs2.getString("Tid")%>" onclick="return confirm('Are you sure you want to delete this Task?');"><img src="images/delete.png" width="50" height="30"></a></td>
	
		<td><a href="updatestatusdate.jsp?tid=<%=rs2.getString("Tid")%>"><img src="images/edit1.jpeg" width="60" height="30"></a></td>
			...
			<%while(rs.next())
			    ...
			    {
				  %> 
					<td><font size =3 color = "black">Already Set</font><img src="images/tick.png" width="30" height="30"></td>
				<%
			    }
			    else{
				%>		  
		<td><a href="addreminder.jsp?tid=<%=rs2.getString("Tid")%>"><img src="images/reminder.png" width="60" height="30"></a></td>
			<%
				}
...
{
	System.out.println("exception in display.jsp "+e);
	}
