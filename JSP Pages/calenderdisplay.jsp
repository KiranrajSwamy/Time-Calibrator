...
<center><font size = "6"color = "red"><b>Particular day task</b></font></center>
<br>
<center>
<table border="10" align="center"  cellpadding="20" cellspacing="4" bordercolor = "red" >
<tr bgcolor="#dee5a0">
	<td><font size = 5.5 color = "brrowen">&nbsp;Name&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;Date&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;Time&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;Description&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;priority&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
    <td><font size = 5.5 color = "brrowen">&nbsp;StatusDate&nbsp;</font></td>
</tr>
...
{%>
		...
		<tr>
			...
			<td><font size =3 color = "black"><%=rs.getString("Tdate")%></font></td>
			<td><font size =3 color = "black"><%=rs.getString("Ttime")%></font></td>
			<td><font size =3 color = "black"><%=rs.getString("Tdescription")%></font></td>
			<td><font size =3 color = "black"><%=rs.getString("Tpriority")%></font></td>
		
<%if(rs.getString("Tstatusdate").equals("1909-09-09") )
			{
			%>
			...
			{
			%><td><font size =3 color = "black">completed on:<%=rs.getString("Tstatusdate")%></font></td>
			<%}
			%>
...
<br/>
<a href="calendar.jsp"><img src="images/back2.png" width="100" height="40" style="top:100px;"></a>		
