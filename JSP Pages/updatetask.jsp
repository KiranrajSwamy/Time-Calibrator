...
<fieldset style="border-width: 10px;">
	<legend><font size = "6" color = "#462276"><b>Update Task</b></font></legend>
	<br><br>
		...
		<form method=get action="../UpdateTask">
			...
			<table>
				<tr>
					...
					<td><input type=text name=tname value="<%=rs.getString("Tname") %>" required="">
					</td>
				</tr>
				<tr>
					<td><font size=3 color=black>Date:</font></td>
					<td><input type=text name=date value="<%=rs.getString("Tdate") %>"  id="inputField" required=""><i>(yyyy/mm/dd)</i></td>
				</tr>
				<tr>
					<td><font size=3 color=black>Time:</font></td>
					<td><input type=text name=time value="<%=rs.getString("Ttime") %>" pattern="[0-2]{1}[0-9]{1}:[0-5]{1}[0-9]{1}" required=""  >eg:23:50(hh:mm) </td>
				</tr>

				<tr>
					<td><font size=3 color=black>Description:</font></td>
					<td>
					<textarea name="description" rows="5" cols="40"  required=""><%=rs.getString("Tdescription") %></textarea></td>
				</tr>
