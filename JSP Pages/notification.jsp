...
<body>
<center><font size = "6"color = "red"><b>Notofication</b></font></center>
<br>
<center>
<table border="10" align="center" cellpadding="15" cellspacing="4" bordercolor = "red" width="50%" bgcolor = "#f0f0f0">
	<tr>
	<td><font size = 5.5 color = "brrowen">&nbsp;Name&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;Date&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;Description&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;priority&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;Update&nbsp;&nbsp; Status&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;Email Task&nbsp;&nbsp;</font></td>
...
try
{
	...
	{   %>
		<tr>
			<td><font size =3 color = "black"><%=rs2.getString("Tname")%></font></td>
			<td><font size =3 color = "black"><%=rs2.getString("Tdate")%></font></td>
			<td><font size =3 color = "black"><%=rs2.getString("Tdescription")%></font></td>
			<td><font size =3 color = "black"><%=rs2.getString("Tpriority")%></font></td>
			<td><a href="updatestatusdate.jsp?tid=<%=rs2.getString("Tid")%>"><img src="images/edit1.jpeg" width="90" height="40"></a></td>
			<td><a href="../NotificationEmail?tid=<%=rs2.getString("Tid")%>"><img src="images/email.jpg" width="110" height="55"></a></td>
