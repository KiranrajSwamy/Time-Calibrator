...
<fieldset style="border-width: 10px;">
	<legend><font size = "6" color = "#462276"><b>Your Diary</b></font></legend>
	<br><br>

<table>
<tr><td>
<font size=5 color=red>Date:</font></td><td><font size=5 color=black><%=rs.getString("Ddate") %></font></td></tr>
<tr/><tr/><tr/><tr/><tr><td>
<font size=5 color=red>Content:</font></td>
<td><font size=4 color=black><u><%=rs.getString("Dcontent") %></u></font></td></tr>
...
<a href="readdiary.jsp"><img src="images/back2.png" width="80" height="40" style="top:100px;"></a></td></tr>
