...
<fieldset style="border-width: 10px;">
	<legend><font size = "6" color = "#462276"><b>Add Contact</b></font></legend>
	<br><br>
...
function validate()
	{
	if(!check_username(document.myform.fname.value) ||document.myform.fname.value=="" || document.myform.fname.value==null)
			{
				alert("Check the First name...!!!");
				return false;
			}
			else
				if(!check_contact_no(document.myform.cellno.value)|| document.myform.cellno.value=="" || document.myform.cellno.value==null)
				{
					alert("Check the Cell No...!!!");
					return false;
				}			
		return true;
...
<tr>
	<td><font size="4" color="black"><i><b>Enter the First Name<font color=red>*</font></b></i></font></td>
	<td><input type=text name=fname  pattern="^[a-zA-Z\-]{3,30}$" style="height:20px;font-size:14pt;" required=""></td>
	<tr><td class= "separator"></td></tr>

</tr>
<tr>
	<td><font size="4" color="black"><i><b>Enter the Last Name</b></i></font> </td>
	<td><input type=text name=lname pattern="^[a-zA-Z\-]{3,30}$" style="height:20px;font-size:14pt;">
	 </td>
	<tr><td class= "separator"></td></tr>
...
<tr>
	<td><font size="4" color="black"><i><b>Enter the Email-id</b></i></font></td>
	<td><input type=text name=email pattern="^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,4})$" style="height:20px;font-size:14pt;"></td>
	<tr><td class= "separator"></td></tr>

</tr>
<tr>
	<td><font size="4" color="black"><i><b>Enter the Address</b></i></font></td>
<td><textarea name=address style="height:100px;font-size:14pt;" ></textarea></td>
	<tr><td class= "separator"></td></tr>

</tr>

<tr>
	<td><font size="4" color="black"><i><b>Enter the Home Contact</b></i></font></td>
<td><input type=text name=homecontactno maxlength="9" style="height:20px;font-size:14pt;" pattern="^[0-9\-]{8}$" ></td>
	<tr><td class= "separator"></td></tr>

</tr>
<tr>
	<td><font size="4" color="black"><i><b>Enter the Cell no<font color=red>*</font></b></i></font></td>

	<td><input type=text name=cellno pattern="^[0-9\-]{10}$" maxlength="10" style="height:20px;font-size:14pt;" required=""></td>
	<tr><td class= "separator"></td></tr>

</tr>
<tr>
	<td><font size="4" color="black"><i><b>Enter the Office no</b></i></font></td>
	<td><input type=text name=officeno maxlength="9" pattern="^[0-9\-]{8}$" style="height:20px;font-size:14pt;"></td>
	<tr><td class= "separator"></td></tr>
