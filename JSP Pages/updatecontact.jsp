...
<%  	int cid=Integer.parseInt(request.getParameter("cid"));
		...
		ResultSet rs1=Db.select("select * from Contactbook where Cid="+cid );
  	   	rs1.next();
%>  
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<center>
<fieldset style="border-width: 10px;">
	<legend><font size = "6" color = "#462276"><b>Update Contact</b></font></legend>
	<br><br>

<head><title>Update Contact</title>
<style>
	.separator{height:20px}
</style>
</head>
<body bgcolor="yellow" text="#FF0000">
		<form method="get" action="../UpdateContact">

			<table>
				<tr>
					<td><font color=black size=3>Enter the First Name:</font></td>
					<td><input type=text name=fname value="<%=rs1.getString("Firstname")  %>" pattern="^[a-zA-Z\-]{3,30}$"  required>
					</td>
					<tr><td class= "separator"></td></tr>
				</tr>
				<tr>
					<td><font color=black size=3>Enter the Last Name:</font></td>
					<td><input type=text name=lname value="<%=rs1.getString("Lastname") %>" pattern="^[a-zA-Z\-]{3,30}$" >
					</td>
					<tr><td class= "separator"></td></tr>
				</tr>
				<tr>
					<td><font color=black size=3>Enter the Email-id:</font></td>
					<td><input type=email name=email value="<%=rs1.getString("Email") %>">
					</td>
					<tr><td class= "separator"></td></tr>
				</tr>

				<tr>
					<td><font color=black size=3>Enter the Address:</font></td>
					<td><textarea name=address value="<%=rs1.getString("Address") %>"></textarea>
					</td>
					<tr><td class= "separator"></td></tr>
				</tr>
				<tr>
					<td><font color=black size=3>Enter the Homecontactno:</font></td>
					<td><input type=text name=homecontactno value="<%=rs1.getString("Homecontactno") %>" maxlength="8" pattern="^[0-9\-]{8}$" >
					</td>
					<tr><td class= "separator"></td></tr>
				</tr>
				<tr>
					<td><font color=black size=3>Enter the Cellno:</font></td>
					<td><input type="text" name=cellno value="<%=rs1.getString("Cellno") %>" maxlength="10" pattern="^[0-9\-]{10}$" required>
					</td>
					<tr><td class= "separator"></td></tr>
				</tr>
				<tr>
					<td><font color=black size=3>Enter the Officeno:</font></td>
					<td><input type=text name=officeno value="<%=rs1.getString("Officeno") %>" maxlength="8" pattern="^[0-9\-]{8}$" >
					</td>
					<tr><td class= "separator"></td></tr>
				</tr>
...
<a href="showcontact.jsp"><img src="images/back2.png" width="100" height="40" style="top:100px;"></a>
</body>
</div>
