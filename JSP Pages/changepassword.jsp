...
function validate()
	...
	//String numToken="[\\p{Digit}&&[123456789]]+";
			if(!check_pwd(document.myform.oldpassword.value) ||document.myform.oldpassword.value=="" || document.myform.oldpassword.value==null)
			{
				alert("Check the Current password...!!!");
				return false;
			}
		else
			if(!check_pwd(document.myform.newpassword.value)|| document.myform.newpassword.value=="" || document.myform.newpassword.value==null)
			{
				...
				if(!check_pwd(document.myform.cpassword.value)|| document.myform.cpassword.value=="" || document.myform.cpassword.value==null)
				{
					alert("Check the confirm password...!!!");
					return false;
				}
				else
				if(document.myform.newpassword.value != document.myform.cpassword.value)
				{
...
<form method=get action="../ChangePassword" name="myform" onsubmit = "return validate();">
