...
<form action="../ViewIncompletedPriority" method=get>
<head>

<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Priority Range</title>
...
<fieldset style="border-width: 10px;">
	<legend><font size = "6" color = "#462276"><b>From-To Date</b></font></legend>
	<br><br>

<table>
<tr>
	<td><font size=3 color=black>Enter from date</font></td>
	<td><input type=date name="mindate" id="inputField" required=""> </td>
</tr>
<tr>
	<td><font size=3 color=black>Enter to date</font></td>
	<td><input type=date name="maxdate" id="inputField1" required=""> </td>
	<tr><td class= "separator"></td></tr>
		
</tr>
<tr>
	<td><font size=3 color=black>Enter to Priority</font> </td>
	...
	<option value="not important-not urgent">not important-not urgent</option>
			...
			<tr>
			<td><td><input type=submit name=submit value="view">
