...
%>
<%    ResultSet rs=Db.select("select * from Task,Reminder where Reminder.Tid=Task.Tid and Tstatusdate='1909/09/09' and Uid="+uid);
  	%>  
...
<center><font size = "6"color = "red"><b>Show Reminders </b></font></center>
<br>
<center>
<table border="5" align="center"  cellpadding="2" cellspacing="2" bordercolor = "red">
	<tr bgcolor="#dee5a0">
	<td><font size = 5.5 color = "brrowen">&nbsp;Name&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;Description&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;priority&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;ReminderTime&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;ReminderDate&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;Update&nbsp;</font></td>
	<td><font size = 5.5 color = "brrowen">&nbsp;Delete&nbsp;</font></td>

</tr>

<%while(rs.next()){ %>
<tr>
<td><font size =3 color = "black"><%=rs.getString("Tname")%></font></td>
<td><font size =3 color = "black"><%=rs.getString("Tdescription")%></font></td>
<td><font size =3 color = "black"><%=rs.getString("Tpriority")%></font></td>
<td><font size =3 color = "black"><%=rs.getString("Rtime")%></font></td>
<td><font size =3 color = "black"><%=rs.getString("Rdate")%></font></td>

<td><font size =3 color = "black"><a href="updatereminder.jsp?rid=<%=rs.getString("Rid")%>"><img src="images/edit.png" width="70" height="40"></a></font></td>
<td><font size =3 color = "black"><a href="../DeleteReminder?rid=<%=rs.getString("Rid")%>" onclick="return confirm('Are you sure you want to delete this Reminder?');"><img src="images/delete.png" width="70" height="40"></a></font></td>
</tr>
<%}%>
