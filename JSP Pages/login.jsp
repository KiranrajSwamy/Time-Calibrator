...
<head>
  ...
  <!-- invalid login condition to display alert box 
<c:if test="${not emptyloginError}">
<script>
...
<tr>
	...
	<td><input type=text name=contact maxlength="10" style="height:28px;font-size:10pt;"></td>
	<tr><td class= "separator"></td></tr>
...
<input type="image" src="images/register.jpg" alt="Submit" width="180" height="50">
...
<p>
<h3>"Time Calibrator refers to a range of skills, tools, and techniques utilized to accomplish specific tasks, projects and goals. This set encompass a wide scope of activities, and these include planning, setting goals, delegation, analysis of time spent, monitoring, organizing, scheduling, and prioritizing. Initially time management referred to just business or work activities, but eventually the term broadened to include personal activities also.</h3></h3>
</p>
                                </div>
                                ...
                                <div class="toggle-content" id="tab5">
                                    ...
                                    <p><font  color="black">
										...
										- Security.<br>
										- You can Add Task<br>
										- You can view Today Task in Eisenhower Matrix.<br>
										- You can Add Reminder to Task<br>
										- You can Create Your Personal Diary<br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="toggle-content  spacing">
                                    <h1>Contact Us</h1>
                                    <p>
											<font  color="black"><h4>1.Name :Gaurav Agarwal<br>
