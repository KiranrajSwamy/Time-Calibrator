...
<fieldset style="border-width: 10px;">
	<legend><font size = "6" color = "#462276"><b>Update StatusDate</b></font></legend>
	<br><br>
...
<body bgcolor="yellow" text="#FF0000">
		<form method="get" action="../UpdateStatusDate">
			<table>
				<tr>
				...
				<tr>
					<td><font size=3 color=black>Status Date:</font></td>
					<td><input type=text name=tstatusdate id="inputField" required=""></td>
				</tr>
				<tr>
...
<td><a href="../DisplayTask"><img src="images/back2.png" width="100" height="40" style="top:100px;"></a></a></td>
</body>
