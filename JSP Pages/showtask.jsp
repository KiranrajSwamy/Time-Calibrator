...
<table>
<head>Show Task</head>
<tr><td>task name</font></td><td>task date</td><td>task time</td><td>description</td><td>priority</td><td>task status date</td><td>Update</td><td>Delete</td><td>Task Status Date</td><td>Reminder</td></tr> 
...
<td><%=rs.getString("Ttime")%></td>
<td><%=rs.getString("Tdescription")%></td>
<td><%=rs.getString("Tpriority")%></td>
<td><%=rs.getString("Tstatusdate")%></td>
<td><a href="updatetask.jsp?tid=<%=rs.getString("Tid")%>">edit</a></td>
<td><a href="../DeleteTask?tid=<%=rs.getString("Tid")%>">delete</a></td>
<td><a href="updatestatusdate.jsp?tid=<%=rs.getString("Tid")%>">updatestatusdate</a></td>
<td><a href="addreminder.jsp?tid=<%=rs.getString("Tid")%>">Add reminder</a></td>
