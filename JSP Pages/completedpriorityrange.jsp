...
<form action="../ViewCompletedPriority" method=get>
<head>
...
<tr>
	<td><font color=black size=3>Enter from date</font></td>
	<td><input type=date name="mindate" id="inputField" required=""> </td>
</tr>
<tr>
	<td><font color=black size=3>Enter to date</font></td>
	<td><input type=date name="maxdate" id="inputField1" required=""> </td>
	<tr><td class= "separator"></td></tr>
		
</tr>
<tr>
	<td><font color=black size=3>Enter to Priority </font></td>
