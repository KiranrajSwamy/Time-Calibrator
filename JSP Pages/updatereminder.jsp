...
%>
  <% int rid=Integer.parseInt(request.getParameter("rid"));
    ...
    ResultSet rs=Db.select("select * from Task,Reminder where Rid="+rid);
  	rs.next();
	%>  
...
</head><body bgcolor="yellow" text="#FF0000">
		<form method=get action="../UpdateReminder">
			<center>

<fieldset style="border-width: 10px;">
	<legend><font size = "6" color = "#462276"><b>Update Reminder</b></font></legend>
	<br><br>

			<table>
				<tr>
					<td><font color=black size=3>Task Name:</font></td>
					<td><input type=text name=tname value="<%=rs.getString("Tname") %>" readonly="readonly">
					</td>
				</tr>
				<tr>
					<td><font color=black size=3>Description:</font></td>
					<td><textarea name=description readonly="readonly"><%=rs.getString("Tdescription") %></textarea></td>
				</tr>

				<tr>
					<td><font color=black size=3>Priority:</font></td>
				...
				<tr>
					<td><font color=black size=3>Reminder Date</font></td>
					<td><input type=date name=rdate value=<%=rs.getString("Rdate")%> id="inputField" required=""><i>(yyyy/mm/dd)</i></td>			
				</tr>
				
				<tr>
					<td><font color=black size=3>Reminder time:</font></td>
					<td><input type=text name="rtime" value="<%=rs.getString("Rtime")%>" pattern="[0-2]{1}[0-9]{1}:[0-5]{1}[0-9]{1}" required="">eg:23:50(hh:mm)</td>
				</tr>
				<tr><td><td><input type=submit name=submit value="update">
					</td></td>
				...
				<a href="showremindertask.jsp"><img src="images/back2.png" width="100" height="40" style="top:100px;"></a>
					<a href=""></a>
</body>
</html>
