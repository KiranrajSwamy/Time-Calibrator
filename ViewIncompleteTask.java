...
/**
 * Servlet implementation class ViewIncompleteTask
 */
@WebServlet("/ViewIncompleteTask")
public class ViewIncompleteTask extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewIncompleteTask() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			response.sendRedirect("JspPages/viewincompletedtask.jsp");
		}
		catch(Exception e)
		{
