...
/**
 * Servlet implementation class ViewIncompletedPriority
 */
@WebServlet("/ViewIncompletedPriority")
public class ViewIncompletedPriority extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewIncompletedPriority() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			response.sendRedirect("JspPages/viewincompletedpriority.jsp");
		}
		catch(Exception e)
		{
